...
public class Item3HibernateSpringBootJustManyToOneApplication {

	private final BookstoreService bookstoreService;

	public Item3HibernateSpringBootJustManyToOneApplication(BookstoreService bookstoreService) {
		this.bookstoreService = bookstoreService;
	}

	public static void main(String[] args) {
		SpringApplication.run(Item3HibernateSpringBootJustManyToOneApplication.class, args);
	}
